...
export default function SignInButton() {
    ...
    >
        <div className="p-3 border border-1 rounded-lg flex w-64">
            <button type="submit" className="text-center text-lg flex">
                <div className="grow-0 p-2"><LogosGoogleIcon width={25} height={25}/></div>
                <div className="grow text-center py-1 px-3">Signin with Google</div>
            </button>
        </div>
    </form>
    )
